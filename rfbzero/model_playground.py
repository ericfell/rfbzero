...
(current_profile, conc_ox_CLS_profile, conc_red_CLS_profile, conc_ox_NCLS_profile, conc_red_NCLS_profile,
 ...
 mt_profile, loss_profile, del_ox, del_red) = setup.CC_experiment(voltage_limit_charge, voltage_limit_discharge,
                                                   current, True)
# CCCV_experiment(voltage_limit_charge, voltage_limit_discharge, 0.005, -0.005,
#                                                    current, True)
